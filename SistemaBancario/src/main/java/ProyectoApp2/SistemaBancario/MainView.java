...
import ProyectoApp2.SistemaBancario.Cliente;
...
public class MainView extends Application {
    ...
    public void start(Stage primaryStage) {
      ...
      //Evento que se ejecuta cuando el usuario presiona el boton Retirar
        retiroButton.setOnAction(e -> {
        	try {
        	    double monto = Double.parseDouble(montoField.getText()); // Convierte el texto ingresado a numero 
