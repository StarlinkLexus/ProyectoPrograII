...
public class Main extends Application {
	...
	public void start(Stage stage) {
		...
		// Botón agregarCuenta: crea una nueva cuenta del tipo seleccionado y la asocia
		// al cliente
		...
		stage.setScene(new Scene(root, 450, 550)); // Crear escena con tamaño fijo
		stage.setTitle("******BANCO PICHINCHA****"); // Título de la ventana
